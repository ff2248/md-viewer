...
contains:[e.inherit(e.TITLE_MODE,{begin:/\w[\w\d_]*/})],relevance:0};return{
name:"Bash",aliases:["sh","zsh"],keywords:{$pattern:/[a-z][a-z0-9._-]+/,
keyword:["if","then","else","elif","fi","time","for","while","until","in","do","done","case","esac","coproc","function","select"],
literal:["true","false"],
built_in:["break","cd","continue","eval","exec","exit","export","getopts","hash","pwd","readonly","return","shift","test","times","trap","umask","unset","alias","bind","builtin","caller","command","declare","echo","enable","help","let","local","logout","mapfile","printf","read","readarray","source","sudo","type","typeset","ulimit","unalias","set","shopt","autoload","bg","bindkey","bye","cap","chdir","clone","comparguments","compcall","compctl","compdescribe","compfiles","compgroups","compquote","comptags","comptry","compvalues","dirs","disable","disown","echotc","echoti","emulate","fc","fg","float","functions","getcap","getln","history","integer","jobs","kill","limit","log","noglob","popd","print","pushd","pushln","rehash","sched","setcap","setopt","stat","suspend","ttyctl","unfunction","unhash","unlimit","unsetopt","vared","wait","whence","where","which","zcompile","zformat","zftp","zle","zmodload","zparseopts","zprof","zpty","zregexparse","zsocket","zstyle","ztcp","chcon","chgrp","chown","chmod","cp","dd","df","dir","dircolors","ln","ls","mkdir","mkfifo","mknod","mktemp","mv","realpath","rm","rmdir","shred","sync","touch","truncate","vdir","b2sum","base32","base64","cat","cksum","comm","csplit","cut","expand","fmt","fold","head","join","md5sum","nl","numfmt","od","paste","ptx","pr","sha1sum","sha224sum","sha256sum","sha384sum","sha512sum","shuf","sort","split","sum","tac","tail","tr","tsort","unexpand","uniq","wc","arch","basename","chroot","date","dirname","du","echo","env","expr","factor","groups","hostid","id","link","logname","nice","nohup","nproc","pathchk","pinky","printenv","printf","pwd","readlink","runcon","seq","sleep","stat","stdbuf","stty","tee","test","timeout","tty","uname","unlink","uptime","users","who","whoami","yes"]
...
className:"type",variants:[{begin:"\b[a-z\d_]*_t\b"},{
match:/atomic_[a-z]{3,6}/}]},l={className:"string",variants:[{
begin:'(u8?|U|L)?"',end:'"',illegal:"\n",contains:[e.BACKSLASH_ESCAPE]},{
begin:"(u8?|U|L)?'(\\(x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4,8}|[0-7]{3}|\S)|.)",
end:"'",illegal:"."},e.END_SAME_AS_BEGIN({
begin:/(?:u8?|U|L)?R"([^()\ ]{0,16})\(/,end:/\)([^()\ ]{0,16})"/})]},o={
className:"number",variants:[{match:/(0b[01']+)/},{
match:/(-?)([\d']+(\.[\d']*)?|\.[\d']+)((ll|LL|l|L)(u|U)?|(u|U)(ll|LL|l|L)?|f|F|b|B)/
},{
match:/(-?)(0[xX][a-fA-F0-9]+(?:'[a-fA-F0-9]+)*(?:\.[a-fA-F0-9]*(?:'[a-fA-F0-9]*)*)?(?:[pP][-+]?[0-9]+)?(l|L)?(u|U)?)/
},{match:/(-?)\d+(?:'\d+)*(?:\.\d*(?:'\d*)*)?(?:[eE][-+]?\d+)?/}],relevance:0
},c={className:"meta",begin:/#\s*[a-z]+/,end:/$/,keywords:{
keyword:"if else elif endif define undef warning error line pragma _Pragma ifdef ifndef elifdef elifndef include"
},contains:[{begin:/\
...
begin:"[+-]?\b(?:0[Bb][01](?:'?[01])*|0[Xx][0-9A-Fa-f](?:'?[0-9A-Fa-f])*|0(?:'?[0-7])*|[1-9](?:'?[0-9])*)(?:[Uu](?:LL?|ll?)|[Uu][Zz]?|(?:LL?|ll?)[Uu]?|[Zz][Uu]|)"
}],relevance:0},l={className:"meta",begin:/#\s*[a-z]+/,end:/$/,keywords:{
keyword:"if else elif endif define undef warning error line pragma _Pragma ifdef ifndef include"
},contains:[{begin:/\
...
begin:t.concat(//,/(?!decltype)/,/(?!if)/,/(?!for)/,/(?!switch)/,/(?!while)/,e.IDENT_RE,t.lookahead(/(<[^<>]+>|)\s*\(/))
...
match:[/(?:enum(?:\s+(?:class|struct))?|class|struct|union)/,/\s+/,/\w+/],
...
begin:/#(([0-9a-fA-F]{3,4})|(([0-9a-fA-F]{2}){3,4}))/},FUNCTION_DISPATCH:{
...
variants:[e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,{begin:"`",end:"`"}]},{
className:"number",variants:[{
match:/-?0[xX]\.[a-fA-F0-9](_?[a-fA-F0-9])*[pP][+-]?\d(_?\d)*i?/,relevance:0
},{
match:/-?0[xX](_?[a-fA-F0-9])+((\.([a-fA-F0-9](_?[a-fA-F0-9])*)?)?[pP][+-]?\d(_?\d)*)?i?/,
relevance:0},{match:/-?0[oO](_?[0-7])*i?/,relevance:0},{
match:/-?\.\d(_?\d)*([eE][+-]?\d(_?\d)*)?i?/,relevance:0},{
match:/-?\d(_?\d)*(\.(\d(_?\d)*)?)?([eE][+-]?\d(_?\d)*)?i?/,relevance:0}]},{
begin:/:=/},{className:"function",beginKeywords:"func",end:"\s*(\{|$)",
excludeEnd:!0,contains:[e.TITLE_MODE,{className:"params",begin:/\(/,end:/\)/,
...
}]},t={className:"literal",begin:/on|off|true|false|yes|no/},r={
...
return e=>{
const a=e.regex,n="[�-ʸa-zA-Z_$][�-ʸa-zA-Z_$0-9]*",i=n+t("(?:<"+n+"~~~(?:\s*,\s*"+n+"~~~)*>)?",/~~~/g,2),r={
keyword:["synchronized","abstract","private","var","static","if","const ","for","while","strictfp","finally","protected","import","native","final","void","enum","else","break","transient","catch","instanceof","volatile","case","assert","package","default","public","try","switch","continue","throws","protected","public","private","module","requires","exports","do","sealed","yield","permits","goto","when"],
literal:["false","true","null"],
type:["char","boolean","long","float","int","byte","short","double"],
...
match:[/(?:class|interface|enum|extends|implements|new)/,/\s+/,n],className:{
1:"keyword",3:"title.class"}},{match:/non-sealed/,scope:"keyword"},{
...
match:l.either(/JSON/,/[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),
className:"title.class",keywords:{_:[...t,...s]}},I={variants:[{
match:[/function/,/\s+/,d,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],
className:{1:"keyword",3:"title.function"},label:"func.def",contains:[R],
illegal:/%/},x={
match:l.concat(//,(T=[...r,"super","import"].map((e=>e+"\s*\(")),
...
relevance:0},{match:[/constructor(?=\s*\()/],className:{1:"title.function"},
contains:[R]},x,{relevance:0,match:/[A-Z][A-Z_0-9]+/,
...
begin:/(break|continue|return|this)/,starts:{contains:[{className:"symbol",
...
className:"string",variants:[{begin:'@"',end:'"',illegal:"\n",
contains:[e.BACKSLASH_ESCAPE]}]},{className:"meta",begin:/#\s*[a-z]+/,end:/$/,
keywords:{
keyword:"if else elif endif define undef warning error line pragma ifdef ifndef include"
},contains:[{begin:/\
/,relevance:0},e.inherit(e.QUOTE_STRING_MODE,{
...
variants:[{begin:/\$\d/},{
begin:n.concat(/[$%@](?!")(\^\w|#\w+(::\w+)*|\{\w+\}|\w+(::\w*)*)/,"(?![A-Za-z])(?![@$%])")
},{begin:/[$%@](?!")[^\s\w{=]|\$=/,relevance:0}],contains:[i]},o={
className:"number",variants:[{match:/0?\.[0-9][0-9_]+/},{
match:/v?(0|[1-9][0-9_]*(\.[0-9_]+)?|[1-9][0-9_]*)/},{
match:/0[0-7][0-7_]*/},{match:/0x[0-9a-fA-F][0-9a-fA-F_]*/},{
match:/0b[0-1][0-1_]*/}],relevance:0
...
(()=>{var e=(()=>{"use strict";return e=>{
const t=e.regex,a=/(?![A-Za-z0-9])(?![$])/,r=t.concat(/[a-zA-Z_-�][a-zA-Z0-9_-�]*/,a),n=t.concat(/(\?[A-Z][a-z0-9_-�]+|\?[A-Z]+(?=[A-Z][a-z0-9_-�])){1,}/,a),o=t.concat(/[A-Z]+/,a),c={
...
match:[t.concat(/::/,t.lookahead(/(?!class)/)),m],scope:{2:"variable.constant"
}},{match:[/::/,/class/],scope:{2:"variable.language"}},{
match:[n,t.concat(/::/,t.lookahead(/(?!class)/)),m],scope:{1:"title.class",
3:"variable.constant"}},{match:[n,t.concat("::",t.lookahead(/(?!class)/))],
...
match:[//,t.concat("(?!fn\b|function\b|",g(b).join("\b|"),"|",g(E).join("\b|"),"\b)"),r,t.concat(l,"*"),t.lookahead(/(?=\()/)],
...
contains:[{match:/\?>/,scope:"meta",endsParent:!0}]}},{scope:"meta",variants:[{
begin:/<\?php/,relevance:10},{begin:/<\?=/},{begin:/<\?/,relevance:.1},{
begin:/\?>/}]},{scope:"variable.language",match:/\$this/},c,O,I,{
...
contains:[e.inherit(e.UNDERSCORE_TITLE_MODE,{scope:"title.class"})]},{
beginKeywords:"use",relevance:0,end:";",contains:[{
match:/(as|const|function)/,scope:"keyword"},e.UNDERSCORE_TITLE_MODE]},d,_]}
...
contains:[{begin:/# type:/},{begin:/#/,end:/\B/,endsWithParent:!0}]},m={
className:"params",variants:[{className:"",begin:/\(\s*\)/,skip:!0},{begin:/\(/,
...
illegal:/(<\/|\?)|=>/,contains:[i,g,{scope:"variable.language",match:/self/
},{beginKeywords:"if",relevance:0},{match:/or/,scope:"keyword"
},o,p,e.HASH_COMMENT_MODE,{match:[/def/,/\s+/,a],scope:{1:"keyword",
3:"title.function"},contains:[m]},{variants:[{
...
(()=>{var e=(()=>{"use strict";return e=>{
const n=e.regex,a="([a-zA-Z_]\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\*\*|[-/+%^&*~`|]|\[\]=?)",s=n.either(/([A-Z]+[a-z0-9]+)+/,/([A-Z]+[a-z0-9]+)+[A-Z]+/),i=n.concat(s,/(::\w+)*/),t={
"variable.constant":["__FILE__","__LINE__","__ENCODING__"],
"variable.language":["self","super"],
keyword:["alias","and","begin","BEGIN","break","case","class","defined","do","else","elsif","end","END","ensure","for","if","in","module","next","not","or","redo","require","rescue","retry","return","then","undef","unless","until","when","while","yield","include","extend","prepend","public","private","protected","raise","throw"],
built_in:["proc","lambda","attr_accessor","attr_reader","attr_writer","define_method","private_constant","module_function"],
...
begin:/%[qQwWx]?\|/,end:/\|/},{begin:/\B\?(\\d{1,3})/},{
begin:/\B\?(\x[A-Fa-f0-9]{1,2})/},{begin:/\B\?(\u\{?[A-Fa-f0-9]{1,6}\}?)/},{
begin:/\B\?(\M-\C-|\M-\c|\c\M-|\M-|\C-\M-)[ -~]/},{
begin:/\B\?\(c|C-)[ -~]/},{begin:/\B\?\?\S/},{
begin:n.concat(/<<[-~]?'?/,n.lookahead(/(\w+)(?=\W)[^
]*
(?:[^
]*
...
className:"title.function.invoke",relevance:0,
begin:t.concat(//,/(?!let|for|while|if|else|match)/,i,t.lookahead(/\s*\(/))
...
begin:[/^\s*/,/end/,/\s+/,/(extension)?/],beginScope:{2:"keyword",4:"keyword"}
},{match:/\.inline/},{begin:/inline(?=\s)/,keywords:"inline"},{
...
match:r.concat(//,r.either(...n),/\s*\(/),relevance:0,keywords:{built_in:n}}
;function o(e){
return r.concat(//,r.either(...e.map((e=>e.replace(/\s+/,"\s+")))),//)}
const c={scope:"keyword",
match:o(["create table","insert into","primary key","foreign key","not null","alter table","add constraint","grouping sets","on overflow","character set","respect nulls","ignore nulls","nulls first","nulls last","depth first","breadth first"]),
relevance:0};return{name:"SQL",case_insensitive:!0,illegal:/[{}]|<\//,keywords:{
$pattern:/[\w\.]+/,keyword:((e,{exceptions:r,when:t}={})=>{const a=t
...
$pattern:a(/\w+/,/#\w+/),keyword:C.concat(m),literal:r},B=[E,k,N],D=[{
match:t(/\./,a(...p)),relevance:0},{className:"built_in",
match:t(//,a(...p),/(?=\()/)}],_={match:/->/,relevance:0},M=[_,{
...
match:`\b0x(${L})(\.(${L}))?([pP][+-]?(${x}))?\b`},{match:/0o([0-7]_*)+/
},{match:/0b([01]_*)+/}]},I=(e="")=>({className:"subst",variants:[{
...
match:t(/@/,f)}],H={match:n(/[A-Z]/),relevance:0,contains:[{className:"type",
...
contains:[{className:"keyword",match:/_/},{className:"params",match:f}]
...
match:[/(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},
...
match:[/class/,/\s+/,/func/,/\s+/,/[A-Za-z_][A-Za-z0-9_]*/],scope:{
1:"keyword",3:"keyword",5:"title.function"}},{match:[/class/,/\s+/,/var/],
...
className:{1:"keyword",3:"title.function"},label:"func.def",contains:[R],
illegal:/%/},I={
match:l.concat(//,(C=[...c,"super","import"].map((e=>e+"\s*\(")),
...
relevance:0},{match:[/constructor(?=\s*\()/],className:{1:"title.function"},
contains:[R]},I,{relevance:0,match:/[A-Z][A-Z_0-9]+/,
