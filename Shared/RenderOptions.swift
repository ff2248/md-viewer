...
struct RenderOptions: Equatable {
    ...
    ///
    /// Each entry lists multiple acceptable bundle IDs to absorb variants:
    /// VS Code Insiders, older Sublime Text 3 installs, or a future
    /// rebranding of Cursor away from its current ToDesktop wrapper.
    static let recommendedExternalEditors: [(bundleIDs: [String], displayName: String)] = [
        // Cursor's current bundle ID is generated by the ToDesktop framework
        // it ships with. The trailing `230313mzl4w4u92` is a project hash —
        // unstable-looking but verified correct against /Applications/Cursor.app.
        // The two extra IDs are forward-compat slots in case Cursor migrates.
        (["com.todesktop.230313mzl4w4u92", "com.anysphere.cursor", "com.cursor.Cursor"], "Cursor"),
        (["com.microsoft.VSCode", "com.microsoft.VSCodeInsiders"], "Visual Studio Code"),
